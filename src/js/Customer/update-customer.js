if(localStorage.getItem("data")){
    ...
    document.getElementById('update-customer-btn').addEventListener('click',()=>{
        if(document.getElementById("name").value === ""|| document.getElementById("lastname").value === ""|| document.getElementById("lastname").value === ""|| document.getElementById("address").value === "" || document.getElementById("city").value === "" || document.getElementById("cellphone").value === "" || document.getElementById("email").value === ""){
            document.getElementById(
              "alert"
